...
class __parameters__:
    def __init__(self):
        self.num_modes = 10
        self.num_measure_pnts = self.num_modes + 1
        self.max_data_files = 200
        self.useCache = True
        self.optimization_variable = "mach_iso" #"p" #"p" #mach_iso
...
class __dirs__:
    ...
    @property
    def save_plot_dir(self):
        directory = self.root + os.sep + "plots"
        if not os.path.exists(directory):
            os.makedirs(directory)
        return directory


dirs = __dirs__('/home/wgryglas/AVIO/data/naca0012-condition_number')
